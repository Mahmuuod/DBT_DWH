...
concat(datekey,transaction_id,customer_id,store_id,promotion_id,category_id,p.product_id) as nature_key,
datekey,
transaction_id,
customer_id,
store_id,
case promotion_id when 1 then 343
when 2 then 326
when 3 then 324
when 4 then 345
when 5 then 325
else 0 end as promotion_id,
category_id,
p.product_id,
transaction_time,
